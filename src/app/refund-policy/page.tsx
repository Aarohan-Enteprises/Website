...
export const metadata: Metadata = {
  title: 'Refund Policy',
  description: 'Read the refund policy for PineCoder.in. Milestone-based payment approach ensures transparency and satisfaction.',
